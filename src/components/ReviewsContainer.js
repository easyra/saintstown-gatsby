    ...
    <StyledSection style={{ width: "80%" }}>
      ...
      <StyledReviewList>
        ...
        <ReviewCard author="HOLLY TERRY" title="INTERIOR DESIGNER" review={``}>
          ...
          <p>
            " ACTIONS that validate and confirm the written words are CRUCIAL
            and a HUGE TURN ON! "
          </p>
          <p>
            " Thank you for a wonderful night/morning last night and an
            incredible evening via DFW and the deposits you are making that
            keeps a woman intrigued. "
          </p>
        </ReviewCard>
      </StyledReviewList>
    </StyledSection>
